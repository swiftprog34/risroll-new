...
<head>
    ...
    <title>Техас</title>
    <meta name="description" content="Техас - доставка и самовывоз в Тюмени!">
    ...
    <!--Open Graph-->
    <meta property="og:url" content="https://ris72.ru/zapechennie-rolli/124-tehas" />
...
Тюмень, ул. Эрвье, д.10</span>
            ...
            <div class="container">
                ...
                <div class="menu">
                    ...
                    <div class="second_row">
                        ...
                        <a href="https://ris72.ru/%D0%A0%D2%91%D0%A0%D1%95%D0%A1%D0%83%D0%A1%E2%80%9A%D0%A0%C2%B0%D0%A0%D0%86%D0%A0%D1%94%D0%A0%C2%B0">Доставка и Оплата</a>
        ...
        <nav class="desktop">
            ...
            <div class="container">
                <div class="menu">
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods01.png@20230423141958" alt="Холодные роллы" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods11.jpg@20230423142020" alt="Запечённые роллы" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods02.png@20230423142038" alt="Тёплые роллы" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods03.jpg@20230423142059" alt="Сеты" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods04.jpg@20230423142111" alt="Поке" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods05.jpeg@20230423142138" alt="Том ям" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods06.jpg@20230423142209" alt="Гунканы" />
                    ...
                    <div class="menu_item">
                        <img class="preview" src="/client/admin/images/categories/goods07.jpg@20230423142243" alt="Закуски" />
                        <a href="../zakuski.html">Закуски</a>
                    </div>



                    <div class="menu_item"><a href="../index.html#">Еще</a><img class="arrow" src="/client/images/icons/ic_menu_down_black.png" alt="" /><ul class="submenu h4">
                ...
                <a rel="nofollow" class="basket" href="https://ris72.ru/%D0%A0%D1%94%D0%A0%D1%95%D0%A1%D0%82%D0%A0%C2%B7%D0%A0%D1%91%D0%A0%D0%85%D0%A0%C2%B0">
                    <span class="s_h2 basketPrice">0₽</span>
                    <div class="icon rounded basket-area"><img src="/client/images/icons/ic_basket-2_white.png" alt="" /></div>
                </a>
            </div>
    ...
    <div class="win win_hide" id="navmenu-page" style="display: none;">
        ...
        <div class="body">
            ...
            <div class="nav_list">
                ...
                <a class="item r2" href="https://ris72.ru/%D0%A0%D1%94%D0%A0%D1%95%D0%A0%D0%85%D0%A1%E2%80%9A%D0%A0%C2%B0%D0%A0%D1%94%D0%A1%E2%80%9A%D0%A1%E2%80%B9">
                    <i class="ic_win_info black"></i>
                    <span>Контакты</span>
                    <img src="/client/images/icons/ic_link.png">
                </a>
                <a class="item r2" href="https://ris72.ru/%D0%A0%D2%91%D0%A0%D1%95%D0%A1%D0%83%D0%A1%E2%80%9A%D0%A0%C2%B0%D0%A0%D0%86%D0%A0%D1%94%D0%A0%C2%B0">
                    <i class="ic_win_info black"></i>
            ...
            <div class="win_categories_grid">
                <a class="item r3" href="../holodnie-rolli.html">
                    <img class="photo" src="/client/admin/images/categories/goods01.png@20230423141958" alt="Холодные роллы" />
                    <span class="cat">Холодные роллы</span>
                </a>
                <a class="item r3" href="../zapechennie-rolli.html">
                    <img class="photo" src="/client/admin/images/categories/goods11.jpg@20230423142020" alt="Запечённые роллы" />
                    <span class="cat">Запечённые роллы</span>
                </a>
                <a class="item r3" href="../teplie-rolli.html">
                    <img class="photo" src="/client/admin/images/categories/goods02.png@20230423142038" alt="Тёплые роллы" />
    ...
    <nav class="mobile">
        <div class="container">
            ...
            <a class="icon back" href="https://ris72.ru/history.back();return&#32;false;" onclick="history.back();return false;">
                <img src="/client/images/icons/ic_back_black.png" alt="" />
            </a>

            <a class="icon close_page" href="../index.html" onclick="history.back();return false;">
    ...
    <div class="bottom_bar">
        ...
        <div class="item basket" href="">
            ...
            <a class="basket-area-mobile" href="https://ris72.ru/%D0%A0%D1%94%D0%A0%D1%95%D0%A1%D0%82%D0%A0%C2%B7%D0%A0%D1%91%D0%A0%D0%85%D0%A0%C2%B0" onclick="(document.getElementById('page-preloader').style.display='flex')">
    ...
    <div class="sidebar">
        ...
        <li style="display: flex; align-items: center;">
            ...
            <a style="float: right; background: #c20609; border-radius: 1200px; padding: 2px 12px; font-size: 16px; color: #fff !important; text-align: center;" href="https://ris72.ru/user/login.php">Войти</a>
        </li>
        ...
        <div class="menu_items">
            <a href="../holodnie-rolli.html">
                <img src="/client/admin/images/categories/goods01.png@20230423141958" width="40px" alt="Холодные роллы" />
                Холодные роллы            </a>
            <a href="../zapechennie-rolli.html">
                <img src="/client/admin/images/categories/goods11.jpg@20230423142020" width="40px" alt="Запечённые роллы" />
                Запечённые роллы            </a>
    ...
    <main class="animated fadeIn container">
        ...
        <a class="back_menu" href="https://ris72.ru/history.back();return&#32;false;" onclick="history.back();return false;">
            <i class="ic_back"></i>
        ...
        <section class="product" id="item-{{$product->id}}">
            ...
            <div class="product-item ani">
                ...
                <div class="item_photo ">
                    <img class="photo" src="/client/admin/images/maxi/goods11/13916663656444f119112f27.51474733.jpg" title="{{$product->title}}" alt="{{$product->title}}" />
                </div>
                ...
                <div class="information">
                    ...
                    <div class="product_row item_weight">
                        ...
                        <input type='hidden' id='price-{{$product->id}}' value='{{$product->price}}' data-external_id=''>
                    </div>
...
<noscript><div><img src="https://mc.yandex.ru/watch/93405038" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
